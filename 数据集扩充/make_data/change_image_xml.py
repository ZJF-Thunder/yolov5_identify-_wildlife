...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=5,
                 ...
                 add_noise_rate=0.5, add_gussian_rate=0.5, flip_rate=0.5,
                 cutout_rate=0.5, cut_out_length=50, cut_out_holes=1, cut_out_threshold=0.5,
                 is_addNoise=True, is_changeLight=True, is_cutout=True, is_rotate_img_bbox=True,
                 is_crop_img_bboxes=True, is_shift_pic_bboxes=True, is_filp_pic_bboxes=True, is_addGussian=True):
        ...
        self.add_gussian_rate = add_gussian_rate
        ...
        self.is_addGussian = is_addGussian
    ...
    def dataAugment(self, img, bboxes):
        ...
        while change_num < 1:  # 默认至少有一种数据增强生效
            ...
            if self.is_addGussian:
                if random.random() < self.add_gussian_rate:  # 加高斯模糊
                    change_num += 1
                    img = self._addGussian(img)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='data/source_Images')
    parser.add_argument('--source_xml_path', type=str, default='data/source_Annotations')
    parser.add_argument('--save_img_path', type=str, default='data/all_images')
    parser.add_argument('--save_xml_path', type=str, default='data/all_xml')
